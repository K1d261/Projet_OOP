...
class Thermite(Unit):
    def __init__(self, x, y):
        super().__init__(x, y, health=12000, attack_power=5000, defense=5000, speed=500000, team='player', role='Thermite (Demolitionist)', image_path='assets/images/thermite.png')
